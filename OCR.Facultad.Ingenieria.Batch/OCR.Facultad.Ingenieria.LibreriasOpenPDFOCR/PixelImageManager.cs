...
namespace OCR.Facultad.Ingenieria.LibreriasOpenPDFOCR
{
    ...
    /// </summary>
    public class PixelImageManager
    {
        /// <summary>
        ...
        protected static ColorPalette GetColorPalette(uint nColors)
        {
        ...
        /// <returns></returns>
        public static Bitmap SaveGIFWithNewColorTable(System.Drawing.Image image, uint nColors, bool fTransparent)
        {
